...
namespace Duplicati.GUI.Strings {
    ...
    internal class WizardHandler {
        ...
        /// <summary>
        ///   Looks up a localized string similar to HMB is currently paused, so the backup won&apos;t run until HMB is resumed.
        ///Do you want HMB to resume now so the backup can run immediately?.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to The previous HMB setup is now restored!.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to HMB attempted to stop the backup, but did not succeed.
