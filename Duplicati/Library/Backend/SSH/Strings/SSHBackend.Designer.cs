...
namespace Duplicati.Library.Backend.Strings {
    ...
    internal class SSHBackend {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The host is not authenticated, please connect to the host using SSH, and then re-rerun HMB, log: {0}.
        /// </summary>
