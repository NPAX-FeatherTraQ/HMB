...
namespace Duplicati.Library.Backend.Strings {
    ...
    internal class CloudFiles {
        ...
        /// <summary>
        ///   Looks up a localized string similar to HMB will assume that the credentials given are for a US account, use this option if the account is a UK based account. Note that this is equivalent to setting --{0}={1}..
        /// </summary>
