...
namespace Duplicati.Library.Interface.Strings {
    ...
    internal class Common {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The connection succeeded but another backup was found in the destination folder. It is possible to configure HMB to store multiple backups in the same folder, but it is not recommended.
        ///
