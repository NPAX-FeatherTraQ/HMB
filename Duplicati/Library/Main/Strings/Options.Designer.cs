...
namespace Duplicati.Library.Main.Strings {
    ...
    internal class Options {
        ...
        /// <summary>
        ///   Looks up a localized string similar to When performing asynchronous uploads, HMB will create volumes that can be uploaded. To prevent HMB from generating too many volumes, this option limits the number of pending uploads. Set to zero to disable the limit.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to By supplying this option, HMB will transmit files, while building volumes. This can shorten the time it takes to perform a backup, but requires more diskspace..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to If a backup is interrupted there will likely be partial files present on the backend. Using this flag, HMB will automatically remove such files when encountered..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to A flag indicating that HMB should remove unused files.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Any string used to prefix the filenames generated by HMB..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to HMB supports plugable compression modules. Use this option to select a module to use for compression. This is only applied when creating new volumes, when reading an existing file, the filename is used to select the compression module..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to If the backup is encrypted, the remote backend cannot verify the backup contents without the password. If this option is activated, HMB stores an unencrypted file on the backend. The file is never read by HMB, but allows the remote server to verify the backup integrity without requiring a password. The file contains no sensitive information, only a list of files that are expected to exist on the backend and their respective hashes. This option only has an effect when creating a backup and when verifying a b [rest of string was truncated]&quot;;.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to When an error occurs, HMB will silently retry, and only report the number of retries. Enable this option to have the error messages displayed when a retry is performed..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to If HMB detects that the target folder is missing, it will create it automatically. Activate this option to prevent automatic folder creation..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to The operating system keeps track of the last time a file was written. Using this information, HMB can quickly determine if the file has been modified. If some application deliberately modifies this information, HMB won&apos;t work correctly unless this flag is set..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to When deciding if a full backup should be made or an old backup should be deleted, HMB will adjust the times by a small fraction to ensure that minor time differences do not interfer with expected operation. If the backup is set to produce a full backup each day, and a full backup is made at, say 12:00:01, and the backup is executed again at 12:00:00, a full day has not passed and thus an incremental backup is performed. To avoid this, HMB inserts a 1% tolerance (max 1 hour). Use this option to disable the t [rest of string was truncated]&quot;;.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to If USN is enabled the USN numbers are used to find all changed files since last backup. Use this option to disable the use of USN numbers, which will make HMB investigate all source files. This option is primarily intended for testing and should not be disabled in a production environment. If USN is not enabled, this option has no effect..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to HMB supports plugable encryption modules. Use this option to select a module to use for encryption. This is only applied when creating new volumes, when reading an existing file, the filename is used to select the encryption module..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to By default, HMB will restore all files in the backup. Use this option to restore only a subset of the files.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to When deleting old files, HMB will only write out what files are supposed to be deleted. Specify the &quot;force&quot; option to actually remove them..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to If the last full backup is older than the duration supplied here, HMB will make a full backup, otherwise an incremental.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to When this flag is specified, HMB will make a full backup of all files, and ignore any incremental data..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to By default, HMB will use the AES encryption algorithm to encrypt the backup volumes, setting this flag makes HMB use the GNU Privacy Guard instead. GnuPG must be installed on the machine for this to work..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Some protocols, like FTP, and some servers have problems detecting an interrupted transfer and will assume that the transfer completed, even if it did not. If this option is enabled HMB will list the contents of the backend after each upload and verify that the file exists and has the expected size..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to By setting this value you can limit how much bandwidth HMB consumes for downloads. Setting this limit can make the backups take longer, but will make HMB less intrusive..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to By setting this value you can limit how much bandwidth HMB consumes for uploads. Setting this limit can make the backups take longer, but will make HMB less intrusive..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to HMB will attempt to perform multiple operations on a single connection, as this avoids repeated login attempts, and thus speeds up the process. This option can be used to ensure that each operation is performed on a seperate connection.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to If an upload or download fails, HMB will retry a number of times before failing. Use this to handle unstable network connections better..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to By setting this option the filenames generated by HMB will contain a time separator as well as a timezone component, which is not cross platform compatible.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to If HMB encounters a file that is opened by another program, it will attempt to read whatever contents that are in the file. Since the file may be written during the backup, this can cause the backup to contain a partially written file. Use this option to disable this, omitting locked files from the backup. This option has no effect if a snapshot is active..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Supply a passphrase that HMB will use to encrypt the backup volumes, making them unreadable without the passphrase. This variable can also be supplied through the environment variable PASSPHRASE..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to By default, HMB will restore files from the most recent backup, use this option to select another item. You may use relative times, like &quot;-2M&quot; for a backup from two months ago..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to After a failed transmission, HMB will wait a short period before attempting again. This is usefull if the network drops out occasionally during transmissions..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to HMB now uses a filename format that is portable across all operating systems, so this option should not be used and will be removed in the future.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to If the filesystem does not support the long filenames that HMB uses, this switch will change the time to be a much more compact, but hard to read format. It will also make the default prefix &quot;dpl&quot;..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to If this path is supplied, HMB will store all signature files here, so re-downloads can be avoided..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Supply a list of files separated with semicolons, that will be added to each backup. The HMB GUI program uses this to store the setup database with each backup..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to If the hash for the volume does not match, HMB will refuse to use the backup. Supply this flag to allow HMB to proceed anyway..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to This settings controls the usage of snapshots, which allows HMB to backup files that are locked by other programs. If this is set to &quot;off&quot;, HMB will not attempt to create a disk snapshot. Setting this to &quot;auto&quot; makes HMB attempt to create a snapshot, and fail silently if that was not allowed or supported. A setting of &quot;on&quot; will also make HMB attempt to create a snapshot, but will produce a warning message in the log if it fails. Setting it to &quot;required&quot; will make HMB abort the backup if the snapshot creatio [rest of string was truncated]&quot;;.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to HMB will upload files while scanning the disk and producing volumes, which usually makes the backup faster. Use this flag to turn the behavior off, so that HMB will wait for each volume to complete..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to HMB will use the system default temporary folder. This option can be used to supply an alternative folder for temporary storage..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Selects another thread priority for the process. Use this to set HMB to be more or less CPU intensive..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to HMB no longer uses a time separator for the filenames so this option is useless.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Per default, HMB will use the colon &quot;:&quot; character to separate the time fields in the filename. However, on some filesystem, notably windows, this character is not allowed. Use this option to use another character..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to If no files have changed, HMB will not upload a backup set. If the backup data is used to verify that a backup was executed, this option will make HMB upload a backupset even if it is empty.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to This settings controls the usage of NTFS USN numbers, which allows HMB to obtain a list of files and folders much faster. If this is set to &quot;off&quot;, HMB will not attempt to use USN. Setting this to &quot;auto&quot; makes HMB attempt to use USN, and fail silently if that was not allowed or supported. A setting of &quot;on&quot; will also make HMB attempt to use USN, but will produce a warning message in the log if it fails. Setting it to &quot;required&quot; will make HMB abort the backup if the USN usage fails. This feature is only suppor [rest of string was truncated]&quot;;.
        /// </summary>
