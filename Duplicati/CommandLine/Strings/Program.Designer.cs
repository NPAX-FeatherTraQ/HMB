...
namespace Duplicati.CommandLine.Strings {
    ...
    internal class Program {
        ...
        /// <summary>
        ///   Looks up a localized string similar to HMB options:.
        /// </summary>
        ...
        /// Using this system, HMB can detect if you want to backup or restore.
        ...
        /// The cleanup command should not be used unless a backup was interrupted and has left partial files. HMB will inform you if this happens.
        /// The delete command can be used to remove backup sets whe [rest of string was truncated]&quot;;.
        /// </summary>
        ...
        /// HMB uses filters to include and exclude files.
        ///  HMB uses a &quot;first-touch&quot; filter where the first rule that matches a file determines if the file is included or excluded. Internally HMB uses regular expression filters, but supports filters in the form of filename globbing. The order of the commandline arguments also determine what order they are applied in. An example:
        ///    --include=*.txt --exclude=*\Thumbs.db --include=*
        ///
        ///  Even though the last filter includes everything, no files named &quot;Thum [rest of string was truncated]&quot;;.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to ********** HMB v. {0} **********
        ///
        ///Usage:.
        /// </summary>
        ...
        /// HMB uses the time system from duplicity, where times may be presented as:
